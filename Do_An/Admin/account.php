...
?>
    ...
    <head>
        ...
        <title>Thông Tin Tài Khoản - HT SHOP</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark background-blue mb-2">
            ...
            <div class="collapse navbar-collapse">
                ...
                <p class="mx-auto text-notification-header">Thông Tin Tài Khoản</p>
        ...
        <!-- khung hien thi thông tin tài khoản cá nhân -->
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group input-group-sm">
                                    ...
                                    <select disabled id="update_sl_chucvu_nv" class="custom-select mb-3">
                            ...
                            <div class="col-6">
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="update_sl_trangthaihoatdong_nv" class="custom-select mb-3" disabled>
