$(function () {
    /********************** UPDATE INSERT Xã-Huyện-Tỉnh Nhân Viên-Nhà Cung Cấp **********************/
    ///////  CẬP NHẬT Lấy Huyện/Xã Khi Cập Nhật NHÂN VIÊN 
    //lay quan huyen (cập nhật NHÂN VIÊN)
    ...
    //lay quan xa (cập nhật NHÂN VIÊN)
