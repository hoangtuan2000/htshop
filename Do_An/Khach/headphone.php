...
<head>
    ...
    <script src="javascript/javascript-ajax-filter-headphone.js"></script>
...
<body>
    ...
    <?php
    //xem Tai Nghe khuyến mãi có số lượng bao nhiêu để in ra slider cho đúng
    $num_tainghe_khuyenmai = mysqli_num_rows($query_tainghe_khuyenmai);
                ...
                <div class="background-blue ml-3 mr-3 mt-1 pb-1 rounded w-100">
                    ...
                    <div class="col-md-12 p-0">
                        <div id="topproduct" class="carousel slide p-1" data-ride="carousel" data-interval="700000">
                            ...
                            <?php
                            //nếu Tai Nghe khuyến mãi có số lượng lớn hơn 8 thì in ra 3 slider sản phẩm nổi bật
                            if ($num_tainghe_khuyenmai > 8) {
                            ?>
                                    ...
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-12 ml-1">
                                                <?php
                                                //biến lưu lại ID Tai Nghe khuyến mãi đã hiển thị
                                                $displayed = "";
                                                $index = 1;
                                                while ($result_rand_tainghe = mysqli_fetch_array($query_rand_tainghe_khuyenmai)) {
                                                    //nếu là sản phẩm đầu tiên thì khỏi thêm dấu phẩy phía trước và ngược lại
                                                    if ($index == 1) {
                                                        $displayed .= $result_rand_tainghe['id_sp'];
                                                    } else {
                                                        $displayed .= "," . $result_rand_tainghe['id_sp'];
                                                    }
                                                    $index++;
                                                            ...
                                                            <div class="p-1">
                                                                ...
                                                                <div class="text-center">
                                                                    <p class="text-name-product">
                                                                        <?php echo $result_rand_tainghe['ten_sp'] ?>
                                                                    </p>
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-12 ml-1">
                                                <?php
                                                include 'function/function_show_database.php';
                                                //hàm dùng để lấy query Tai Nghe khuyến mãi chưa hiển thị (limit là 5)
                                                $query = get_tainghe_khuyenmai_not_displayed($displayed);
                                                while ($result_rand_tainghe = mysqli_fetch_array($query)) {
                                                    //thêm ID Tai Nghe khuyến mãi đã hiện thị vào biến $displayed để sử dụng cho slider thứ 3
                                                    $displayed .= "," . $result_rand_tainghe['id_sp'];
                                                    $khuyenmai = get_khuyenmai($result_rand_tainghe['id_km']);
                                                    $gia_old = money_format($result_rand_tainghe['gia_sp']);
                                                    $gia_new = price_after_promotion($result_rand_tainghe['gia_sp'], $khuyenmai['giam_km']);
                            ...
                            <?php
                                //nếu Tai Nghe khuyến mãi có số lượng lớn hơn >5 và <9 thì in ra 2 slider sản phẩm nổi bật
                            } else if ($num_tainghe_khuyenmai > 5 && $num_tainghe_khuyenmai < 9) {
                            ?>
                                <ol class="carousel-indicators">
                                    <li data-target="#topproduct" data-slide-to="0" class="active"></li>
                                    <li data-target="#topproduct" data-slide-to="1"></li>
                            ...
                            <?php
                                //nếu Tai Nghe khuyến mãi có số lượng <6 thì in ra 1 slider sản phẩm nổi bật
                            } else if ($num_tainghe_khuyenmai < 6) {
                            ?>
                                <ol class="carousel-indicators">
                                    <li data-target="#topproduct" data-slide-to="0" class="active"></li>
                                </ol>
            ...
            <div class="card">
                <div class="card-header p-0" id="headingOne">
                    <h5 class="m-0">
                        ...
                        <div class="float-right m-1">
                            <button id="btn-filter-asc" value="headphone" class="btn btn-success btn-sm">
                                <i class="fa fa-sort-amount-asc" aria-hidden="true"></i>
                                Giá Tăng Dần
                            </button>
                            <button id="btn-filter-desc" value="headphone" class="btn btn-primary btn-sm">
                ...
                <div id="collapseOne" class="collapse text-filter p-3" aria-labelledby="headingOne" data-parent="#accordion">
                    <div id="div-filter" class="card-body p-2">
                        ...
                        <?php
                        $sql = "SELECT DISTINCT th.id_th, th.ten_th FROM `tainghe` tn, `thuonghieu` th WHERE tn.id_th = th.id_th";
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <button name="filter_detail_gia" data-tab='chua bam' value="gia_sp BETWEEN 200000 AND 500000" type="button" class="btn btn-outline-primary p-1 text-filter-btn">
                                    Từ 200.000đ - 500.000đ
                                </button>
                                <button name="filter_detail_gia" data-tab='chua bam' value="gia_sp BETWEEN 500000 AND 1000000" type="button" class="btn btn-outline-primary p-1 text-filter-btn">
                                    Từ 500.000đ - 1 Triệu
                                </button>
                                <button name="filter_detail_gia" data-tab='chua bam' value="gia_sp BETWEEN 1000000 AND 2000000" type="button" class="btn btn-outline-primary p-1 text-filter-btn">
                                    Từ 1 - 2 Triệu
                                </button>
                            ...
                            <div class="col-6">
                                <b class="text-filter-details">Loại Kết Nối</b> <br>
                                <?php
                                $sql = "SELECT DISTINCT lkn.id_lkn, lkn.ten_lkn FROM `tainghe` tn, `loaiketnoi` lkn WHERE tn.id_lkn = lkn.id_lkn";
                                $query = mysqli_query($con, $sql);
                                while ($result = mysqli_fetch_array($query)) {
                                    if ($result['id_lkn'] != 1) {
                                ?>
                                        <button name="filter_detail" value="id_lkn=<?php echo $result['id_lkn'] ?>" data-tab='chua bam' type="button" class="btn btn-outline-primary p-1 text-filter-btn" style="text-transform: capitalize; min-width: 80px;">
                                            <?php echo $result['ten_lkn'] ?>
                                        </button>
                                <?php
                                    }
                                }
    ...
    <div class="container mb-3">
        <div class="pl-3 pr-3">
            <div class="row" id="show_product">
                <!-- hiển thị Tai Nghe -->
                <?php
                while ($result_all_tainghe = mysqli_fetch_array($query_all_tainghe)) {
                    $khuyenmai = get_khuyenmai($result_all_tainghe['id_km']);
                    $gia_old = money_format($result_all_tainghe['gia_sp']);
                    $gia_new = price_after_promotion($result_all_tainghe['gia_sp'], $khuyenmai['giam_km']);
                    $gia_new = money_format($gia_new);
                ?>
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="500" data-aos-offset="10" data-aos-easing="linear">
                        <div class="card float-left bg-white hover-product div-product magin-1">
                            <a href="product_detail.php?id_product=<?php echo $result_all_tainghe['id_sp'] ?>" class="a-top-product">
                                <img src="<?php echo $result_all_tainghe['anh_sp'] ?>" class="card-img-top d-block width-90 mx-auto image-top-product object-fit-contain" alt="Card image cap">
                                <div class="p-1">
                                    <div class="div-discount">
                                        <?php
                                    ...
                                    <div class="text-center">
                                        <p class="text-name-product"><?php echo $result_all_tainghe['ten_sp'] ?></p>
