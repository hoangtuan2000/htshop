$(function () {
    ...
    $(document).on('click', 'button[name = filter_detail]', function () {
        ...
        // alert(dieu_kien);
        $.post("function/function_filter.php", { send_filter_detail_headphone: "tainghe", send_filter_detail: dieu_kien, send_filter_detail_gia: dieu_kien_gia }, function (result_filter) {
